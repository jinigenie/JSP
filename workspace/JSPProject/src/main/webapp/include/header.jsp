...
<body>
	<!-- header -->
	<div class="brand">Animal Friends</div>        
    <div class="address-bar">유기동물을 신고하고, 실종동물을 찾을 수 있는 서비스</div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<%=request.getContextPath() %>/member/member.jsp">찾아요</a>
                    </li>
                    <li>
                        <a href="<%=request.getContextPath() %>/board/board_list.board">발견했어요</a>
                    </li>

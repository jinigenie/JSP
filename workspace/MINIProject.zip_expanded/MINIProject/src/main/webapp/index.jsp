		...
		<div class="row ">
            ...
            <div class="box">
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"><!-- data-ride="carousel" 자동 슬라이드 기능 -->
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                               	<a href="#"> <img class="img-responsive img-full" src="img/1.jpg"></a>
                            </div>
                            <div class="item">
                                <a href="#"><img class="img-responsive img-full" src="img/2.jpg"></a> <!-- img-full 옵션 class -->
                            </div>
                            <div class="item">
                              	<a href="#">  <img class="img-responsive img-full" src="img/3.jpg"></a>
                            </div>
                ...
                <div class="col-lg-6 text-center" style= "margin-left : 250px">    
						...
						<h2 style = "margin-top: 70px">hello world</h2>
						<p>
							깜빡하신게 있는것 같아요!
						</p>
						<hr>

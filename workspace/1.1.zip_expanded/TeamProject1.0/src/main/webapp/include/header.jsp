...
<body>
    ...
    <div class="address-bar">유기견/묘분실</div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<%= request.getContextPath()%>/lookfor/lookfor_list.lookfor">분실신고</a>
                    </li>
                    <li>
                        <a href="<%=request.getContextPath()%>/board/board_list.board">발견신고</a>
                    </li>
